...
// @ts-ignore
var defaults = LiquidFillGauge.defaultConfig;
var vis = {
    ...
    create: function (element, config) {
        ...
        var elementId = "fill-gauge-".concat(Date.now());
    ...
    update: function (data, element, config, queryResponse, details) {
        ...
        var valueFormat = gaugeConfig.displayPercent ? null : datumField.value_format;
